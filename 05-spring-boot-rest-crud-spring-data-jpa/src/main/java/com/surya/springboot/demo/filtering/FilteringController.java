package com.surya.springboot.demo.filtering;
...
import com.surya.springboot.demo.filtering.SomeBean;
...
public class FilteringController {
	...
	public MappingJacksonValue retrieveListSomeBean() {
		...
		List<SomeBean> someBean = Arrays.asList(new SomeBean("val1","val2","val3"),
